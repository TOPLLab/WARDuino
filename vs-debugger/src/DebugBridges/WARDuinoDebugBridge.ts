...
export class WARDuinoDebugBridgeEmulator implements DebugBridge {
    ...
    private  startEmulator() {
        let command = this.startEmulatorCommand();
        this.cp = spawn('/Users/xtofs/Documents/Programming/ESP_BLINK/ESPWASM/build-emulator/wdcli',['--file','/tmp/warduino/upload.wasm']); 
    ...
    private startEmulatorCommand() {
        return `/Users/xtofs/Documents/Test_VSC/warduinodebug/wdcli --file /tmp/warduino/upload.wasm`
    }
