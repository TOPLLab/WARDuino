...
bool resolvesym(Interpreter *interpreter, char *filename, char *symbol, uint8_t external_kind, void **val,
    ...
    if (nullptr != filename && !strcmp(filename, "env")) {
        switch (external_kind) {
            case 0x00:  // Function
            {
                return interpreter->find_primitive(symbol, (Primitive *)val);
                break;
            }
            case 0x01:  // Table
            {
            ...
            case 2: {
                ...
                for (uint32_t gidx = 0; gidx < import_count; gidx++) {
                    ...
                    do {
                        ...
                        if (resolvesym(interpreter, import_module, import_field,
                        ...
                        if (resolvesym(interpreter, nullptr, sym, external_kind, &val,
                                       &err)) {
                            break;
                        }
