;; https://github.com/WebAssembly/testsuite/blob/1b45c074228bc47f5f1c718a0929e7a3a2c5bb21/br_table.wast
...
;; (assert_ return (invoke "large" (i32.const 0)) (i32.const 0))
;; (assert_ return (invoke "large" (i32.const 1)) (i32.const 1))
;; (assert_ return (invoke "large" (i32.const 100)) (i32.const 0))
;; (assert_ return (invoke "large" (i32.const 101)) (i32.const 1))
;; (assert_ return (invoke "large" (i32.const 10000)) (i32.const 0))
;; (assert_ return (invoke "large" (i32.const 10001)) (i32.const 1))
;; (assert_ return (invoke "large" (i32.const 1000000)) (i32.const 1))
;; (assert_ return (invoke "large" (i32.const 1000001)) (i32.const 1))
...
;; (assert_ return (invoke "as-load-address") (f32.const 1.7))
...
;; (assert_ return (invoke "as-unary-operand") (f32.const 3.4))
